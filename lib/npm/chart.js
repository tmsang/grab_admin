...
! function (t, e) {
  ...
  function Xt(t, e, i, s) {
    ...
    for (l = 0; l < r; l++)
      ...
      for (h = 0, c = d.length; h < c; h++) u = d[h], null == u || Y(u) || (a = Ut(t, n, o, a, u));
    t.restore();
    const f = o.length / 2;
    if (f > i.length) {
  ...
  function de(t, e) {
    ...
    if (!i) return;
    const s = i.listeners,
      n = s.indexOf(e); - 1 !== n && s.splice(n, 1), s.length > 0 || (he.forEach((e => {
      delete t[e]
    })), delete t._chartjs)
  }
  ...
  var ii = {
    ...
    update(t, e, i, s) {
      ...
      const n = Ve(t.options.layout.padding),
        ...
        r = function (t) {
          const e = function (t) {
            ...
            i = Xe(e.filter((t => t.box.fullSize)), !0),
            s = Xe(Ye(e, "left"), !0),
            n = Xe(Ye(e, "right")),
            o = Xe(Ye(e, "top"), !0),
            a = Xe(Ye(e, "bottom")),
      ...
      const f = Object.assign({
        ...
        g = qe(l.concat(h), d);
      Je(r.fullSize, f, d, g), Je(l, f, d, g), Je(h, f, d, g) && Je(l, f, d, g),
        function (t) {
  ...
  function si(t, e = [""], i = t, s, n = (() => t[0])) {
    ...
    return new Proxy(o, {
      ...
      get: (i, s) => li(i, s, (() => function (t, e, i, s) {
        let n;
        for (const o of e)
          if (n = gi(ai(o, t), i), ct(n)) return ri(t, n) ? ui(i, s, t, n) : n
      }(s, e, t, i))),
  ...
  function wi(t, e, i, s, n) {
    let o, a, r, l;
    if (e.spanGaps && (t = t.filter((t => !t.skip))), "monotone" === e.cubicInterpolationMode) yi(t, n);
    else {
  ...
  const Mi = t => 0 === t || 1 === t,
    ki = (t, e, i) => -Math.pow(2, 10 * (t -= 1)) * Math.sin((t - e) * _t / i),
  ...
  class zs extends Ss {
    ...
    _computeLabelSizes(t, e) {
      ...
      for (a = 0; a < e; ++a) {
        if (h = t[a].label, c = this._resolveTickFontOptions(a), i.font = d = c.string, u = s[d] = s[d] || {
          ...
          if (Y(h))
            for (r = 0, l = h.length; r < l; ++r) m = h[r], $(m) || Y(m) || (g = Ut(i, u.data, u.gc, g, m), p += f)
    ...
    getContext(t) {
      ...
      return this.$context || (this.$context = je(this.chart.getContext(), {
        scale: this,
        type: "scale"
      }))
    }
  ...
  class hn {
    ...
    _resize(t, e) {
      ...
      this.width = o.width, this.height = o.height, this._aspectRatio = this.aspectRatio, Me(this, a, !0) && (this.notifyPlugins("resize", {
        size: o
    ...
    buildOrUpdateControllers() {
      ...
      for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++) {
        ...
        if (n.type && n.type !== o && (this._destroyDatasetMeta(i), n = this.getDatasetMeta(i)), n.type = o, n.indexAxis = s.indexAxis || Hs(o, this.options), n.order = s.order || 0, n.index = i, n.label = "" + s.label, n.visible = this.isDatasetVisible(i), n.controller) n.controller.updateIndex(i), n.controller.linkScales();
        else {
    ...
    update(t) {
      ...
      o = this._minPadding = i.layout.autoPadding ? o : 0, this._updateLayout(o), s || J(n, (t => {
        ...
        mode: t
      }), this._layers.sort(en("z", "_idx")), this._lastEvent && this._eventHandler(this._lastEvent, !0), this.render()
    }
    _updateScales() {
      J(this.scales, (t => {
        ii.removeBox(this, t)
    ...
    render() {
      !1 !== this.notifyPlugins("beforeRender", {
        cancelable: !0
      }) && (a.has(this) ? this.attached && !a.running(this) && a.start(this) : (this.draw(), sn({
        chart: this
      })))
    }
    draw() {
    ...
    getContext() {
      return this.$context || (this.$context = je(null, {
        chart: this,
        type: "chart"
      }))
    }
  ...
  class Mn extends ks {
    ...
    _calculateBarValuePixels(t) {
      ...
      } = this, o = s || 0, a = this.getParsed(t), r = a._custom, l = bn(r);
      let h, c, d = a[e.axis],
        u = 0,
  ...
  function Zn(t) {
    const e = Kn(t),
      ...
      o = function (t, e, i) {
        ...
        } = t.getProps(["enableBorderRadius"]), n = t.options.borderRadius, o = Be(n), a = Math.min(e, i), r = t.borderSkipped, l = s || U(n);
        return {
  ...
  class eo extends Ss {
    ...
    draw(t) {
      const {
        ...
        inner: n,
        outer: o
      } = Zn(this), a = (r = o.radius).topLeft || r.topRight || r.bottomLeft || r.bottomRight ? ne : Jn;
      var r;
  ...
  class So extends Ss {
    ...
    _draw() {
      const {
        ...
        align: a,
        labels: r
      } = t, l = xt.color, h = Li(t.rtl, this.left, this.width), c = We(r.font), {
        color: d,
        padding: u
      } = r, f = c.size, g = f / 2;
      let p;
      ...
      const {
        ...
        boxHeight: x,
        itemHeight: b
      } = ko(r, f), _ = this.isHorizontal(), y = this._computeTitleHeight();
      p = _ ? {
    ...
    _getLegendItemAt(t, e) {
      ...
      if ($t(t, this.left, this.right) && $t(e, this.top, this.bottom))
        for (n = this.legendHitBoxes, i = 0; i < n.length; ++i)
          if (s = n[i], $t(t, s.left, s.left + s.width) && $t(e, s.top, s.top + s.height)) return this.legendItems[i];
      return null
    }
    handleEvent(t) {
  ...
  class Ho extends Ss {
    ...
    _positionChanged(t, e) {
      const {
        ...
        caretY: s,
        options: n
      } = this, o = To[n.position].call(this, t, e);
  ...
  Uo.id = "category", Uo.defaults = {
    ticks: {
      callback: Uo.prototype.getLabelForValue
    }
  };
  class qo extends zs {
    constructor(t) {
    ...
    buildTicks() {
      ...
      const s = function (t, e) {
        ...
        for (m && (d && v !== o ? (i.push({
            value: o
          }), v < o && P++, Tt(Math.round((v + P * k) * y) / y, o, Xo(o, _, t)) && P++) : v < o && P++); P < M; ++P) i.push({
          value: Math.round((v + P * k) * y) / y
        });
        return x && d && w !== a ? i.length && Tt(i[i.length - 1].value, a, Xo(a, _, t)) ? i[i.length - 1].value = a : i.push({
          value: a
        }) : x && w !== a || i.push({
          value: w
        }), i
  ...
  return hn.register(Tn, xa, io, $o), hn.helpers = { ...ji
  }, hn._adapters = gn, hn.Animation = cs, hn.Animations = us, hn.animator = a, hn.controllers = Bs.controllers.items, hn.DatasetController = ks, hn.Element = Ss, hn.elements = io, hn.Interaction = Le, hn.layouts = ii, hn.platforms = rs, hn.Scale = zs, hn.Ticks = Ds, Object.assign(hn, Tn, xa, io, $o, rs), hn.Chart = hn, "undefined" != typeof window && (window.Chart = hn), hn
}));